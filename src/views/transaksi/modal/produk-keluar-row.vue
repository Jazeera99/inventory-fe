  ...
  >
    <div class="flex-1 relative">
      ...
      <AppInputSku
        ...
        placeholder="Input SKU Keluar..."
      />

      <p v-if="modelValue.isValid" class="text-[11px] text-red-600 mt-1 font-semibold italic">
    ...
    <div class="w-full md:w-28">
      ...
      <input
        ...
        @input="onInputQty"
        @focus="onFocusQty"
        class="w-full px-3 py-2 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-red-100"
      />
    </div>

    <div class="flex-1">
      <label class="block text-[10px] font-bold text-gray-400 mb-1 uppercase tracking-tight"
        >Keterangan / Tujuan</label
      >
      <input
        type="text"
        :value="modelValue.keterangan"
        @input="onInputKeterangan"
        placeholder="Contoh: Kirim ke Cabang..."
        class="w-full px-3 py-2 border border-gray-300 rounded-lg outline-none focus:ring-2 focus:ring-red-100"
      />
    </div>
