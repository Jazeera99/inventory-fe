...
const props = defineProps<{ isOpen: boolean; initialData: any; availableRoles: string[] }>()
const emit = defineEmits(['close', 'update'])

const form = reactive({ id: null, name: '', email: '', role: '' })
...
const handleSubmit = () => emit('update', { ...form })
</script>
